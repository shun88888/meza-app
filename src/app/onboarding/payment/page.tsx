    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">決済方法設定</h1>
          ...
          <div className="flex items-center justify-center mt-4">
            <div className="flex items-center text-sm text-gray-300">
              ...
              <span className="w-6 h-6 bg-[#FFAD2F] text-white rounded-full flex items-center justify-center text-xs font-bold ml-2 mr-2">2</span>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h2 className="font-semibold text-blue-900 mb-2">💡 なぜ決済方法が必要？</h2>
        ...
        <div className="mt-8 bg-gray-800 rounded-lg p-4">
          <div className="flex items-center mb-2">
            ...
            <h3 className="text-white font-medium">セキュリティ</h3>
          </div>
